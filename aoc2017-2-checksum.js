 ...
 */
{
    var data = "278\t1689\t250\t1512\t1792\t1974\t175\t1639\t235\t1635\t1690\t1947\t810\t224\t928\t859\n" +
...
function checksum1(input) {
    ...
    rows.forEach(function (row) {
        ...
        splitRow.forEach(function (cell) {
            parsedRow.push(parseInt(cell, 10));
        }, splitRow);

        sheet.push(parsedRow);
    }, rows);
    ...
    sheet.forEach(function (row) {
        ...
        row.forEach(function (cell) {
            if (cell > high) high = cell;
            if (cell < low) low = cell;
        }, row);
